    ...
    def process_video(self, video_path, text_prompt, output_dir="./features",
        ...
        while cap.isOpened():
            ...
            if frame_idx % sample_interval == 0:
                ...
                # 保存帧和时间戳
                frame_path = f"{saved_idx:05d}.jpg"
                cv2.imwrite(str(frames_dir / frame_path), frame)
        ...
        # 保存时间戳信息
        np.save(output_dir / "frame_timestamps.npy", np.array(frame_timestamps))
...
def main():
    ...
    datasets = [
        ...
        {
            'path': "/home/zfb/Grounded-SAM-2/Take 2025-02-26 03.11.43 PMpic",
            'video': "61qa0_151148.497-151227.920.mp4"
        }
    ]
